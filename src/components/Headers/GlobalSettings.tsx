...
function GlobalSettings({ setShowSettings, showSettings }: SettingsProps) {
  ...
  return (
    <>
      ...
      <div
        className={`flex flex-col justify-center z-20 fixed h-full w-3/6 right-0 top-0 text-black dark:text-white
       bg-gray-default overflow-x-hidden max-xl:w-7/12 max-lg:w-1/2 max-md:w-full max-lg:items-center transition-all 
       ${
         showSettings
           ? 'slide-in-from-right fade-in'
           : 'slide-out-from-right hidden'
       }`}
      >
        <button
          onClick={() => setShowSettings(!showSettings)}
        ...
        <div className="ml-32 flex flex-col justify-between max-lg:-ml-7 max-lg:items-center max-lg:w-1/2">
          <h1 className=" text-start text-3xl font-light mb-20">
            Configuração
          </h1>
        ...
        <div className="ml-32 flex gap-7 flex-wrap max-lg:ml-0 max-lg:items-center max-lg:w-1/2">
          ...
          <a
            ...
            className={`bg-yellow-500 selector ${
          ...
          <a
            ...
            className={`bg-orange-500 selector ${
          ...
          <a
            ...
            className={`bg-blue-primary selector ${
          ...
          <a
            ...
            className={`bg-gray-300 selector ${
              activeColor === 'gray' ? 'active' : ''
            }`}
            href="#"
          >
          ...
          <a
            ...
            className={`bg-dark-blue-primary selector ${
              activeColor === 'dark_blue' ? 'active' : ''
            }`}
            href="#"
          >
          ...
          <a
            ...
            className={`bg-red-primary selector ${
          ...
          <a
            ...
            className={`bg-pink-300 selector ${
